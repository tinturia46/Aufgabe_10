...
(function AssetStorage$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm15.System.Collections.Generic.List$b1.Of($asm00.Fusee.Base.Common.IAssetProvider))) ();
  };
  var $T01 = function () {
  ...
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0F.ProtoBuf.ProtoContractAttribute)) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm12.System.Linq.Enumerable)) ();
  };
  var $T05 = function () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm09.Fusee.Serialization.Serializer)) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm15.System.IO.MemoryStream)) ();
  };
  var $T0C = function () {
    return ($T0C = JSIL.Memoize($asm0F.ProtoBuf.Meta.TypeModel)) ();
  };
  var $T0D = function () {
    return ($T0D = JSIL.Memoize($asm15.System.IO.Stream)) ();
  };
  var $T0E = function () {
    return ($T0E = JSIL.Memoize($asm15.System.Int64)) ();
  };
  var $T0F = function () {
    return ($T0F = JSIL.Memoize($asm15.System.Int32)) ();
  };
  var $T10 = function () {
    return ($T10 = JSIL.Memoize($asm00.Fusee.Base.Common.IAssetProvider)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm15.TypeRef("System.Collections.Generic.List`1", [$asm00.TypeRef("Fusee.Base.Common.IAssetProvider")]), null))) ();
  };
  var $S01 = function () {
  ...
  var $S04 = function () {
    return ($S04 = JSIL.Memoize(new JSIL.MethodSignature($asm15.TypeRef("System.Object"), [
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false, ReadOnly:true }, "_providers", $asm15.TypeRef("System.Collections.Generic.List`1", [$asm00.TypeRef("Fusee.Base.Common.IAssetProvider")]));
...
(function Font$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm15.System.Collections.Generic.Dictionary$b2.Of($asm15.System.UInt32, $asm00.Fusee.Base.Common.GlyphInfo))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm15.System.Collections.Generic.Dictionary$b2.Of($asm15.System.UInt32, $asm07.Fusee.Math.Core.Curve))) ();
  };
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm15.System.Collections.Generic.Dictionary$b2.Of($asm15.System.UInt32, $asm15.System.Single))) ();
  };
  var $T03 = function () {
  ...
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm07.Fusee.Math.Core.Curve)) ();
  };
  var $T06 = function () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm15.TypeRef("System.Collections.Generic.Dictionary`2", [$asm15.TypeRef("System.UInt32"), $asm00.TypeRef("Fusee.Base.Common.GlyphInfo")]), null))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm15.TypeRef("System.Collections.Generic.Dictionary`2", [$asm15.TypeRef("System.UInt32"), $asm07.TypeRef("Fusee.Math.Core.Curve")]), null))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.ConstructorSignature($asm15.TypeRef("System.Collections.Generic.Dictionary`2", [$asm15.TypeRef("System.UInt32"), $asm15.TypeRef("System.Single")]), null))) ();
  };
  var $IM00 = function () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false, ReadOnly:true }, "_glyphInfoCache", $asm15.TypeRef("System.Collections.Generic.Dictionary`2", [$.UInt32, $asm00.TypeRef("Fusee.Base.Common.GlyphInfo")]));

    $.Field({Static:false, Public:false, ReadOnly:true }, "_glyphCurveChache", $asm15.TypeRef("System.Collections.Generic.Dictionary`2", [$.UInt32, $asm07.TypeRef("Fusee.Math.Core.Curve")]));

    $.Field({Static:false, Public:false, ReadOnly:true }, "_glyphAdvanceCache", $asm15.TypeRef("System.Collections.Generic.Dictionary`2", [$.UInt32, $.Single]));
...
(function IO$Members () {
  ...
  JSIL.MakeStaticClass("Fusee.Base.Core.IO", true, [], function ($ib) {
    ...
    $.Method({Static:true , Public:true }, "StreamFromFile", 
      new JSIL.MethodSignature($asm15.TypeRef("System.IO.Stream"), [$.String, $asm00.TypeRef("Fusee.Base.Common.FileMode")]), 
      IO_StreamFromFile
    );
